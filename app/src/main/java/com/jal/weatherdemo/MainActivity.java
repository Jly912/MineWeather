...
public class MainActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void init() {
        ...
        Log.d("print","init"+city);

        Intent intent = getIntent();
        LoginInfo in = (LoginInfo) intent.getSerializableExtra("user");
        if (in!=null){
            info=in;
        }

        String query = intent.getStringExtra("city");
        Log.d("print","cittttt"+query);
        if(query!=null){
            presenter1 = new WeatherPresenter(this, weatherFragment);
            presenter1.loadPost(query);
            pb.setVisibility(View.GONE);

            presenter = new LifePresenter(this, lifeFragment, city);
        }
        ...
        presenter1 = new WeatherPresenter(this, weatherFragment);
        Log.d("print","initFrag"+weatherFragment);
    }
